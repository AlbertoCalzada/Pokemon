...
namespace Pokemon
{
    class Trainer
    {
        ...
        public Trainer(string name, string gender, Bag bag) //Constructor para el inicio del juego, dónde elegiremos el nombre y el género de nuestro jugador.
        {
            this.name = name;
            this.gender = "Chico";
            this.id = GenerateID();
        ...
        public Trainer(Bag bag) //Constructor para el inicio del juego, dónde elegiremos el nombre y el género de nuestro jugador.
        {
            this.name = "Alberto";
            this.gender = "Chico";
            this.id = GenerateID();
